...
namespace PublicFund
{
    public partial class History : Form
    {
        ...
        private void History_Load(object sender, EventArgs e)
        {
            ...
            string qurey1 = "SELECT * FROM SPONSOR WHERE Username LIKE '" + Uname + "' ";
            DataSet ds1 = fn.getData(qurey1);
            string sID = ds1.Tables[0].Rows[0][0].ToString();

            string query2 = "SELECT * FROM DONATION WHERE sID LIKE '"+ sID+"' ";
